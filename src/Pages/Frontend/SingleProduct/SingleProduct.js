...
import image from '../../../Assets/images/Product/headphone3.jpg'
...
export default function SingleProduct() {
  ...
  useEffect(() => {
    ...
    // SetSingleProduct(state.singleProduct.singleProduct)
  }, [id])
        ...
        <div className="flex flex-wrap justify-between my-10">
          ...
          <div className="py-7 mx-auto w-full md:w-[50%] lg:w-[50%]">
            <div>
              ...
              <hr />
              <p className='font-semibold mb-4 mt-6'>ID: <span className='font-light ms-2'>{SingleProduct.id}</span></p>
